...
namespace WCCIS.Specs.Features.MPI
{
    ...
    [NUnit.Framework.DescriptionAttribute("MPI0003 - MPI")]
    public partial class MPI0003_MPIFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/MPI", "MPI0003 - MPI", "MPI search error message validation\r\nCheck error message occurs when NHS Number =" +
                    " No and user presses Search", ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
#line 10
 testRunner.Then("[an error message is displayed \'Fields do not meet search criteria:- Hospital Num" +
                        "ber + Assigning Authority - Surname + Postcode - Surname + Forename + Date of Bi" +
                        "rth - 3 or more Address Lines\']", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
