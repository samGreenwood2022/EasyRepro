...
namespace WCCIS.Specs.Features.MPI
{
    ...
    [NUnit.Framework.DescriptionAttribute("MPISearchErrorCityCounty - MPI")]
    public partial class MPISearchErrorCityCounty_MPIFeature
    {
...
#line 1 "MPISearchErrorCityCounty.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/MPI", "MPISearchErrorCityCounty - MPI", "MPI search error message validation\r\nCheck error message occurs when user enters " +
                    "City and County only", ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("MPI Search when user enters City and County only")]
        [NUnit.Framework.CategoryAttribute("RegressionTest")]
        [NUnit.Framework.CategoryAttribute("MpiPdq")]
        public void MPISearchWhenUserEntersCityAndCountyOnly()
        {
            string[] tagsOfScenario = new string[] {
                    "RegressionTest",
                    "MpiPdq"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("MPI Search when user enters City and County only", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 7
...
#line hidden
#line 9
 testRunner.When("the user only enters the City and County before clicking Search \'Swansea\' \'Swanse" +
