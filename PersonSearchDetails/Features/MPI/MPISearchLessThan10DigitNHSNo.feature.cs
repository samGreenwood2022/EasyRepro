...
namespace WCCIS.Specs.Features.MPI
{
    ...
    [NUnit.Framework.DescriptionAttribute("MPISearchLessThan10DigitNHSNo - MPI")]
    public partial class MPISearchLessThan10DigitNHSNo_MPIFeature
    {
...
#line 1 "MPISearchLessThan10DigitNHSNo.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/MPI", "MPISearchLessThan10DigitNHSNo - MPI", "MPI Search error message validation\r\nCheck that error message occurs when user tr" +
                    "ies to search with an invalid NHS number (less than 10 digits)", ProgrammingLanguage.CSharp, featureTags);
