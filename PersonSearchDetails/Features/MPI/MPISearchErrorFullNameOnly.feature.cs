...
namespace WCCIS.Specs.Features.MPI
{
    ...
    [NUnit.Framework.DescriptionAttribute("MPISearchErrorFullNameOnly - MPI")]
    public partial class MPISearchErrorFullNameOnly_MPIFeature
    {
...
#line 1 "MPISearchErrorFullNameOnly.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/MPI", "MPISearchErrorFullNameOnly - MPI", "MPI search error message validation\r\nCheck error message occurs when user enters " +
                    "forename and surname only", ProgrammingLanguage.CSharp, featureTags);
        ...
        [NUnit.Framework.DescriptionAttribute("MPI Search when user enters forename and surname only")]
        [NUnit.Framework.CategoryAttribute("RegressionTest")]
        [NUnit.Framework.CategoryAttribute("MpiPdq")]
        public void MPISearchWhenUserEntersForenameAndSurnameOnly()
        {
            string[] tagsOfScenario = new string[] {
                    "RegressionTest",
                    "MpiPdq"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("MPI Search when user enters forename and surname only", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 7
...
#line hidden
#line 9
 testRunner.When("the user only enters the forename and surname before clicking Search \'John\' \'Smit" +
