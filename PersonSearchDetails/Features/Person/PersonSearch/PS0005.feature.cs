...
namespace WCCIS.Specs.Features.Person.PersonSearch
{
    ...
    [NUnit.Framework.DescriptionAttribute("PS0005 - Person Search - Address Details")]
    public partial class PS0005_PersonSearch_AddressDetailsFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Person/PersonSearch", "PS0005 - Person Search - Address Details", "Regression Pack Scenario - PS0005\r\nTo ensure a person search can be performed usi" +
                    "ng address details - house nunber & postcode\r\nensure the returned record is corr" +
                    "ect", ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
#line 10
 testRunner.When("i perform a search using house number \'137\' and postcode \'NE6 2EQ\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 11
