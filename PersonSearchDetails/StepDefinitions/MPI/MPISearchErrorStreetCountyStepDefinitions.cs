...
{
    [Binding]
    public class MPISearchErrorStreetCountyStepDefinitions
    {
        private readonly IWebDriver driver;
        private readonly Browser xrmBrowser;

        public MPISearchErrorStreetCountyStepDefinitions(IWebDriver webDriver, Browser browser)//constructor
        {
        ...
        [When(@"the user only enters the street address and county before clicking Search '([^']*)' '([^']*)'")]
        public void WhenTheUserOnlyEntersTheStreetAddressAndCountyBeforeClickingSearch(string Street, string County)
        {
