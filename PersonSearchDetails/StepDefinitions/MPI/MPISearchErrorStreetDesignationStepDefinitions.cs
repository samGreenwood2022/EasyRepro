...
{
    [Binding]
    public class MPISearchErrorStreetDesignationStepDefinitions
    {
        private readonly IWebDriver driver;
        private readonly Browser xrmBrowser;

        public MPISearchErrorStreetDesignationStepDefinitions(IWebDriver webDriver, Browser browser)//constructor
        {
        ...
        [When(@"the user only enters the street address and designation before clicking Search '([^']*)' '([^']*)'")]
        public void WhenTheUserOnlyEntersTheStreetAddressAndDesignationBeforeClickingSearch(string Street, string Designation)
        {
