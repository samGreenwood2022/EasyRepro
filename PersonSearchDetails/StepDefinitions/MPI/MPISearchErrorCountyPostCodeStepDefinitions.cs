...
{
    [Binding]
    public class MPISearchErrorCountyPostCodeStepDefinitions
    {
        private readonly IWebDriver driver;
        private readonly Browser xrmBrowser;

        public MPISearchErrorCountyPostCodeStepDefinitions(IWebDriver webDriver, Browser browser)//constructor
        {
        ...
        [When(@"the user only enters the County and Postcode before clicking Search '([^']*)' '([^']*)'")]
        public void WhenTheUserOnlyEntersTheCountyAndPostcodeBeforeClickingSearch(string County, string Postcode)
        {
