...
{
    [Binding]
    public class MPISearchErrorStreetPostCodeStepDefinitions
    {
        private readonly IWebDriver driver;
        private readonly Browser xrmBrowser;

        public MPISearchErrorStreetPostCodeStepDefinitions(IWebDriver webDriver, Browser browser)//constructor
        {
        ...
        [When(@"the user only enters the street address and postcode before clicking Search '([^']*)' '([^']*)'")]
        public void WhenTheUserOnlyEntersTheStreetAddressAndPostcodeBeforeClickingSearch(string Street, string Postcode)
        {
